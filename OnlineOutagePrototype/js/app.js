...
(function (mapdemo) {
    ...
    mapdemo.CustomRadio = CustomRadio;
})(mapdemo || (mapdemo = {}));
var mapdemo;
(function (mapdemo) {
    'use strict';
    ...
    mapdemo.CustomSelectBox = CustomSelectBox;
})(mapdemo || (mapdemo = {}));
var mapdemo;
(function (mapdemo) {
    'use strict';
    ...
    mapdemo.GooglePlace = GooglePlace;
})(mapdemo || (mapdemo = {}));
var mapdemo;
(function (mapdemo) {
    'use strict';
            ...
            this.link = function (scope, element, attrs, model) {
                ...
                return $(element).iCheck({
                    ...
                    if ($(element).attr('type') === 'checkbox' && attrs['ngModel']) {
                        scope.$apply(function () { return model.$setViewValue($(event.target).attr('checked')); });
                    }
                    if ($(element).attr('type') === 'radio' && attrs['ngModel']) {
...
(function (mapdemo) {
    ...
    mapdemo.PlaceholderForAll = PlaceholderForAll;
})(mapdemo || (mapdemo = {}));
var mapdemo;
(function (mapdemo) {
    'use strict';
    ...
    mapdemo.NotAllowedCharacters = NotAllowedCharacters;
})(mapdemo || (mapdemo = {}));
...
(function (mapdemo) {
    ...
    mapdemo.RootController = RootController;
})(mapdemo || (mapdemo = {}));
/// <reference path='../_all.ts' />
var mapdemo;
(function (mapdemo) {
    ...
    mapdemo.IntroController = IntroController;
})(mapdemo || (mapdemo = {}));
/// <reference path='../_all.ts' />
var mapdemo;
(function (mapdemo) {
    ...
    var HomeController = (function () {
        ...
        HomeController.prototype.showMarkers = function () {
            var _this = this;
            var thisScope = this;
            var poleData = new mapdemo.PoleData(this.$http);
    ...
    mapdemo.HomeController = HomeController;
})(mapdemo || (mapdemo = {}));
/// <reference path='../_all.ts' />
var mapdemo;
(function (mapdemo) {
    ...
    mapdemo.FormController = FormController;
})(mapdemo || (mapdemo = {}));
...
(function (mapdemo) {
    ...
    var mapapp = angular.module('mapapp', ['ngRoute', 'uiGmapgoogle-maps'])
        .controller('rootController', mapdemo.RootController)
        .controller('introController', mapdemo.IntroController)
        .controller('homeController', mapdemo.HomeController)
        .controller('formController', mapdemo.FormController)
        .directive('googleplace', mapdemo.GooglePlace)
        .directive('customradio', mapdemo.CustomRadio.Factory())
        .directive('customselectbox', mapdemo.CustomSelectBox.Factory())
        .directive('icheck', mapdemo.ICheck.Factory())
        .directive('placeholderforall', mapdemo.PlaceholderForAll.Factory())
        .directive('notallowedcharacters', mapdemo.NotAllowedCharacters.Factory());
    mapapp.config(['$routeProvider', function routes($routeProvider) {
    ...
    mapapp.provider("sharedData", mapdemo.SharedData).config(function (sharedDataProvider) {
...
(function (mapdemo) {
    'use strict';
    var PolesResult = (function () {
        function PolesResult() {
        }
        return PolesResult;
    })();
    mapdemo.PolesResult = PolesResult;
})(mapdemo || (mapdemo = {}));
